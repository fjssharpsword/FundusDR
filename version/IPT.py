...
parser.add_argument('--nlayers', type=str, default=14)
parser.add_argument('--num_heads', type=str, default=8)
parser.add_argument('--total_key_depth', type=str, default=512)
parser.add_argument('--total_value_depth', type=str, default=512)
parser.add_argument('--attn_type', type=str, default='local_1d')
parser.add_argument('--distr', type=str, default='dmol')
parser.add_argument('--num_mixtures', type=str, default=10)
parser.add_argument('--filter_size', type=str, default=512)
parser.add_argument('--dropout', type=str, default=0.1)
parser.add_argument('--block_length', type=str, default=256)
parser.add_argument('--initializer_gain', type=str, default=0.2)
args = parser.parse_args()
if __name__ == "__main__":
    #for debug  
    #https://github.com/sahajgarg/image_transformer
    x = torch.rand(10, 3, 256, 256)
    model = ImageTransformer(args)
    out = model(x)
    print(out.size())

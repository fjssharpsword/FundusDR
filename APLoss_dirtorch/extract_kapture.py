...
from APLoss_dirtorch.datasets.generic import ImageList
from APLoss_dirtorch.test_dir import extract_image_features
from APLoss_dirtorch.extract_features import load_model
...
def extract_kapture_global_features(kapture_root_path: str, net, trfs, pooling='mean', gemp=3, whiten=None,
    ...
    if kdata.global_features is None:
        kdata.global_features = kapture.GlobalFeatures('APLoss_dirtorch', gfeat_dtype, gfeat_dsize)
        ...
        assert kdata.global_features.type_name == 'APLoss_dirtorch'

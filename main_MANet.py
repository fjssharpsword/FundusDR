...
from datasets.kaggleDR_MANet import get_train_dataloader_MANet
...
def Train():
    print('********************load data********************')
    dataloader_train = get_train_dataloader_MANet(batch_size=config['BATCH_SIZE'], shuffle=True, num_workers=8, spl_num=5)
